...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCaller) DelegationController(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _RewardsCoordinatorStorage.contract.Call(opts, &out, "delegationController")
...
//
// Solidity: function delegationController() view returns(address)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) DelegationController() (common.Address, error) {
	return _RewardsCoordinatorStorage.Contract.DelegationController(&_RewardsCoordinatorStorage.CallOpts)
}

// DelegationController is a free data retrieval call binding the contract method 0x15d823ef.
//
// Solidity: function delegationController() view returns(address)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCallerSession) DelegationController() (common.Address, error) {
	return _RewardsCoordinatorStorage.Contract.DelegationController(&_RewardsCoordinatorStorage.CallOpts)
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCaller) PoolController(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _RewardsCoordinatorStorage.contract.Call(opts, &out, "poolController")
...
//
// Solidity: function poolController() view returns(address)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) PoolController() (common.Address, error) {
	return _RewardsCoordinatorStorage.Contract.PoolController(&_RewardsCoordinatorStorage.CallOpts)
}

// PoolController is a free data retrieval call binding the contract method 0x4aa9d585.
//
// Solidity: function poolController() view returns(address)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCallerSession) PoolController() (common.Address, error) {
	return _RewardsCoordinatorStorage.Contract.PoolController(&_RewardsCoordinatorStorage.CallOpts)
}
